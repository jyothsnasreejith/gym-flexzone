                  ...
                  <div key={addon.id} className="rounded-lg border overflow-hidden">
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`w-5 h-5 rounded border-2 flex items-center justify-center flex-shrink-0 cursor-pointer transition ${checked ? "border-primary bg-primary" : "border-gray-400 hover:border-primary"}`}
                      >
                        {checked && (
                      ...
                      <div className="px-3 py-2 bg-card border-t grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full h-9 border rounded-lg px-2 text-sm bg-card text-white border-slate-600"
                          />
                        </div>
                        <div>
