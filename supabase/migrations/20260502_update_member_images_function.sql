...
GRANT EXECUTE ON FUNCTION public.update_member_images(UUID, TEXT, TEXT) TO anon, authenticated, service_role;

-- Grant EXECUTE on the function to public (for testing)
GRANT EXECUTE ON FUNCTION public.update_member_images(UUID, TEXT, TEXT) TO public;
